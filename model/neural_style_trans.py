...
style_reference_image_path = 'Style_Image(starrynight).jpg'
...
def prepare_input(base_image_path):
    width, height = load_img(base_image_path).size
    img_nrows = 400
    img_ncols = int(width * img_nrows / height)
...
f_outputs = get_output(combination_image)
